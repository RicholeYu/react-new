...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        output: {
            ...
            filename: isEnvProduction ? "js/[name].[chunkhash:8].js" : "js/[name].[hash:8].js",
        ...
        plugins: [
            ...
            ...paths.appHtmls.map(html => new HtmlWebpackPlugin({
                inject: true,
                template: html.template || paths.appHtml,
        ...
        new ForkTsCheckerWebpackPlugin({
            ...
            new vConsolePlugin({
                enable: process.env.CONSOLE === "true"
            })
        ].filter(Boolean),
